...
@Transactional
class RemoteWaitingPutOffApiServiceTest extends IntegrationTest {
  ...
  void couldNotPutOff() {
    ...
    channelShopIdMapping.put(shopId, "11");
    ...
    AppException appException = assertThrows(
        AppException.class,
        () -> remoteWaitingPutOffApiService.putOff(channelShopIdMapping, waiting.getWaitingId(),
            operationDate, ZonedDateTimeUtils.nowOfSeoul())
    );
